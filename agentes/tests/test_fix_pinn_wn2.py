...
class TestFallbackWN2Determinista:
    ...
    def _wn2_result_con_nieve(self, nieve_cm: float = 35.0) -> dict:
        return {
            "disponible": True,
            "diario": {
                "nieve_24h_cm_p50_corr": nieve_cm,
                "temp_p50_c": -8.0,
            },
            "ventanas": [],
        }
    ...
    def test_fallback_wn2_activa_surcharge(self):
        ...
        assert res["metricas_fisicas"]["fuente_nieve_nueva"] == "wn2_fallback_determinista"
        assert res["estado_manto"] != "ESTABLE", (
